 ...
 */
namespace Lof\MarketPlace\Controller\Adminhtml\Order;

class Index extends \Lof\MarketPlace\Controller\Adminhtml\Order
{
	/**
	...
	public function execute()
	{
		 ...
		 */
		$resultPage->setActiveMenu("Lof_MarketPlace::order");
