...
class Enable extends \Magento\Backend\App\Action
{
    ...
    {
        // check if we know what should be enable
        ...
        if ($id) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('The seller has been approved.'));
        ...
        // display error message
        $this->messageManager->addError(__('We can\'t find a seller to approved.'));
        // go to grid
        return $resultRedirect->setPath('*/*/');
    }
