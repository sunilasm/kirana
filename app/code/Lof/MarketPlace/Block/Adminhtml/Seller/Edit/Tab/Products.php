...
class Products extends Extended
{
    ...
    protected function _construct()
    {
        ...
        if ($this->getSeller() && $this->getSeller()->getId()) {
    ...
    {
        return $this->getSeller() && $this->getSeller()->getRelatedReadonly();
    }
    ...
    protected function _getSelectedProducts()
    {
        ...
        if (!is_array($products)) {
            $products = array_keys($this->getSelectedSellerProducts());
        }
        return $products;
    }
     ...
     * @return array
     */
    public function getSelectedSellerProducts()
    {
        $products = [];
