 ...
 * @since 100.0.2
 */
class ListProduct extends \Magento\Catalog\Block\Product\AbstractProduct implements \Magento\Framework\DataObject\IdentityInterface
{
    /**
    ...
    private function initializeProductCollection()
    {
        ...
        $collection = $layer->getProductCollection()->addAttributeToFilter('approval',array('in' => array(0,2)));
