...
class CustomOptions extends AbstractModifier
{
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Lof_MarketPlace/js/components/dynamic-rows-import-custom-options',
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'render_url' => $this->urlBuilder->getUrl('lofmarketplace/mui/render'),
                                'realTimeLink' => true,
                                'behaviourType' => 'edit',
                                'externalFilterMode' => false,
                                'currentProductId' => $this->request->getPost('id'),
                                'dataLinks' => [
                                    'imports' => false,
                                    'exports' => true
                                ],
    ...
    protected function getCommonContainerConfig($sortOrder)
    {
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'component' => 'Lof_MarketPlace/component/static-type-input',
                                    'valueUpdate' => 'input',
                                    'imports' => [
        ...
        if ($this->helper->getCurrentStoreId()) {
            $useDefaultConfig = [
                'service' => [
                    'template' => 'Lof_MarketPlace/form/element/helper/custom-option-service',
                ]
            ];
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Lof_MarketPlace/js/custom-options-type',
