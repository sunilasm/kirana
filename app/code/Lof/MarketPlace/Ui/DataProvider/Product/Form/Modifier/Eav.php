...
class Eav extends AbstractModifier
{
    ...
    public function modifyData(array $data)
    {
        ...
        if (!$this->request->getPost('id') && $this->dataPersistor->get('catalog_product')) {
    ...
    {
        return (string)$this->request->getParam('type', $this->request->getPost('type_id'));
    }
    ...
    private function getAttributeSetId()
    {
        ...
        return $this->request->getPost('attributr_set_id');
    }
