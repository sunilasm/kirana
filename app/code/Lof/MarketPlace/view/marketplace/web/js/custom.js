...
if (typeof NProgress != 'undefined') {
	...
	function init_flot_chart(){
		...
		if( typeof (jQuery.plot) === 'undefined'){ return; }
        ...
        if (jQuery("#chart_plot_01").length){
			console.log('Plot1');
			
			jQuery.plot( jQuery("#chart_plot_01"), [ arr_data1, arr_data2 ],  chart_plot_01_settings );
		}
		...
		if (jQuery("#chart_plot_02").length){
			...
			jQuery.plot( jQuery("#chart_plot_02"), 
			[{ 
				label: "Email Sent", 
		...
		if (jQuery("#chart_plot_03").length){
			console.log('Plot3');
			
			
			jQuery.plot(jQuery("#chart_plot_03"), [{
				label: "Registrations",
	...
	function init_JQVmap(){
		...
		console.log('init_JQVmap');
			...
			if (jQuery('#world-map-gdp').length ){
	...
	function init_chart_doughnut(){
		...
		var chart_doughnut_settings = {
			...
			jQuery('.canvasDoughnut').each(function(){
	...
	function init_gauge() {
		...
		console.log('init_gauge [' + jQuery('.gauge-chart').length + ']');
		...
		if (jQuery('#chart_gauge_01').length){ 
		...
		if (jQuery('#chart_gauge_02').length){
	...
	/* SPARKLINES */
		...
		function init_sparklines() {
			...
			jQuery(".sparkline_one").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5, 4, 3, 4, 5, 6, 7, 5, 4, 3, 5, 6], {
				type: 'bar',
				height: '125',
				barWidth: 13,
				colorMap: {
			...
			jQuery(".sparkline_three").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 7, 5, 4, 3, 5, 6], {
				type: 'line',
				width: '200',
				height: '40',
				lineColor: '#26B99A',
			...
			jQuery(".sparkline11").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 6, 2, 4, 3, 4, 5, 4, 5, 4, 3], {
				type: 'bar',
				height: '40',
				barWidth: 8,
				colorMap: {
			...
			jQuery(".sparkline22").sparkline([2, 4, 3, 4, 7, 5, 4, 3, 5, 6, 2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 6], {
				type: 'line',
				height: '40',
				width: '200',
				lineColor: '#26B99A',
			...
			jQuery(".sparkline_bar").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5], {
				type: 'bar',
				colorMap: {
					'7': '#a1a1a1'
				},
			...
			jQuery(".sparkline_area").sparkline([5, 6, 7, 9, 9, 5, 3, 2, 2, 4, 6, 7], {
				type: 'line',
				lineColor: '#26B99A',
				fillColor: '#26B99A',
				spotColor: '#4578a0',
			...
			jQuery(".sparkline_line").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5], {
				type: 'line',
				lineColor: '#26B99A',
				fillColor: '#ffffff',
				width: 85,
			...
			jQuery(".sparkline_pie").sparkline([1, 1, 2, 1], {
				type: 'pie',
				sliceColors: ['#26B99A', '#ccc', '#75BCDD', '#D66DE2']
			});
			
			
			jQuery(".sparkline_discreet").sparkline([4, 6, 7, 7, 4, 3, 2, 1, 4, 4, 2, 4, 3, 7, 8, 9, 7, 6, 4, 3], {
				type: 'discrete',
				barWidth: 3,
				lineColor: '#26B99A',
				width: '85',
	   ...
	   /* AUTOCOMPLETE */
		...
		function init_autocomplete() {
			...
			var countriesArray = jQuery.map(countries, function(value, key) {
			  return {
				value: value,
				data: key
			  };
			...
			jQuery('#autocomplete-custom-append').autocomplete({
	 ...
	 /* AUTOSIZE */
		...
		function init_autosize() {
			...
			if(typeof jQuery.fn.autosize !== 'undefined'){
			
			autosize(jQuery('.resizable_textarea'));
	   ...
	   /* PARSLEY */
		...
		function init_parsley() {
			...
			jQuery('#demo-form .btn').on('click', function() {
			  jQuery('#demo-form').parsley().validate();
			  validateFront();
			});
			var validateFront = function() {
			  if (true === jQuery('#demo-form').parsley().isValid()) {
			...
			jQuery('#demo-form2 .btn').on('click', function() {
			  jQuery('#demo-form2').parsley().validate();
			  validateFront();
			});
			var validateFront = function() {
			  if (true === jQuery('#demo-form2').parsley().isValid()) {
				jQuery('.bs-callout-info').removeClass('hidden');
				jQuery('.bs-callout-warning').addClass('hidden');
			  } else {
				jQuery('.bs-callout-info').addClass('hidden');
		  ...
		  /* INPUTS */
			...
			function init_TagsInput() {
				...
				if(typeof jQuery.fn.tagsInput !== 'undefined'){	
		...
		function init_select2() {
			...
			jQuery(".select2_single").select2({
			  placeholder: "Select a state",
			  allowClear: true
			});
			jQuery(".select2_group").select2({});
	   ...
	   /* WYSIWYG EDITOR */
		...
		if( typeof (jQuery.fn.wysiwyg) === 'undefined'){ return; }
	...
	/* CROPPER */
		...
		function init_knob() {
				...
				if( typeof (jQuery.fn.knob) === 'undefined'){ return; }
		...
		function init_InputMask() {
			...
			if( typeof (jQuery.fn.inputmask) === 'undefined'){ return; }
		...
		function init_ColorPicker() {
			...
			if( typeof (jQuery.fn.colorpicker) === 'undefined'){ return; }
			console.log('init_ColorPicker');
			
				jQuery('.demo1').colorpicker();
				jQuery('.demo2').colorpicker();

				jQuery('#demo_forceformat').colorpicker({
					format: 'rgba',
					horizontal: true
				});

				jQuery('#demo_forceformat3').colorpicker({
					format: 'rgba',
				});

				jQuery('.demo-auto').colorpicker();
		...
		function init_IonRangeSlider() {
			...
			if( typeof (jQuery.fn.ionRangeSlider) === 'undefined'){ return; }
			...
			jQuery(".range_min_max").ionRangeSlider({
			  type: "double",
			  min: 0,
			  max: 100,
			  from: 30,
			...
			jQuery(".range_time24").ionRangeSlider({
	   ...
	   function init_daterangepicker_right() {
				...
				var cb = function(start, end, label) {
				  console.log(start.toISOString(), end.toISOString(), label);
				  jQuery('#reportrange_right span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
				};
				...
				jQuery('#reportrange_right span').html(moment().subtract(29, 'days').format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));

				jQuery('#reportrange_right').daterangepicker(optionSet1, cb);

				jQuery('#reportrange_right').on('show.daterangepicker', function() {
				  console.log("show event fired");
				});
				jQuery('#reportrange_right').on('hide.daterangepicker', function() {
				  console.log("hide event fired");
				});
				jQuery('#reportrange_right').on('apply.daterangepicker', function(ev, picker) {
				  console.log("apply event fired, start/end dates are " + picker.startDate.format('MMMM D, YYYY') + " to " + picker.endDate.format('MMMM D, YYYY'));
				});
				jQuery('#reportrange_right').on('cancel.daterangepicker', function(ev, picker) {
				  console.log("cancel event fired");
				});

				jQuery('#options1').click(function() {
				  jQuery('#reportrange_right').data('daterangepicker').setOptions(optionSet1, cb);
				});

				jQuery('#options2').click(function() {
				  jQuery('#reportrange_right').data('daterangepicker').setOptions(optionSet2, cb);
				});

				jQuery('#destroy').click(function() {
				  jQuery('#reportrange_right').data('daterangepicker').remove();
				});
	    ...
	    function init_daterangepicker_single_call() {
			...
			jQuery('#single_cal1').daterangepicker({
			  singleDatePicker: true,
			  singleClasses: "picker_1"
			}, function(start, end, label) {
			  console.log(start.toISOString(), end.toISOString(), label);
			});
			jQuery('#single_cal2').daterangepicker({
			  singleDatePicker: true,
			  singleClasses: "picker_2"
			}, function(start, end, label) {
			  console.log(start.toISOString(), end.toISOString(), label);
			});
			jQuery('#single_cal3').daterangepicker({
			  singleDatePicker: true,
			  singleClasses: "picker_3"
			}, function(start, end, label) {
			  console.log(start.toISOString(), end.toISOString(), label);
			});
			jQuery('#single_cal4').daterangepicker({
			  singleDatePicker: true,
		...
		function init_daterangepicker_reservation() {
			...
			jQuery('#reservation').daterangepicker(null, function(start, end, label) {
			  console.log(start.toISOString(), end.toISOString(), label);
			});

			jQuery('#reservation-time').daterangepicker({
			  timePicker: true,
      ...
      jQuery('.multi.required').on('keyup blur', 'input', function() {
        validator.checkField.apply(jQuery(this).siblings().last()[0]);
      });
	   ...
	   /* CUSTOM NOTIFICATION */
		...
		function init_CustomNotification() {
			...
			TabbedNotification = function(options) {
			  ...
			  if (!document.getElementById('custom_notifications')) {
				...
				jQuery('#custom_notifications ul.notifications').append("<li><a id='ntlink" + cnt + "' class='alert-" + options.type + "' href='#ntf" + cnt + "'><i class='fa fa-bell animated shake'></i></a></li>");
				jQuery('#custom_notifications #notif-group').append(message);
				cnt++;
				CustomTabs(options);
			  }
			};
			...
			CustomTabs = function(options) {
			  jQuery('.tabbed_notifications > div').hide();
			  jQuery('.tabbed_notifications > div:first-of-type').show();
			  jQuery('#custom_notifications').removeClass('dsp_none');
			  jQuery('.notifications a').click(function(e) {
				e.preventDefault();
				var $this = jQuery(this),
				...
				jQuery(tabbed_notifications).children('div').hide();
				jQuery(target).show();
			  });
			};
			...
			jQuery(document).on('click', '.notification_close', function(e) {
			  idname = jQuery(this).parent().parent().attr("id");
			  tabid = idname.substr(-2);
			  jQuery('#ntf' + tabid).remove();
			  jQuery('#ntlink' + tabid).parent().remove();
			  jQuery('.notifications a').first().addClass('active');
			  jQuery('#notif-group div').first().css('display', 'block');
			});
			...
			function init_EasyPieChart() {
				...
				if( typeof (jQuery.fn.easyPieChart) === 'undefined'){ return; }
		...
		function init_compose() {
	   	...
	   	/* CALENDAR */
		    ...
		    function  init_calendar() {
				...
				if( typeof (jQuery.fn.fullCalendar) === 'undefined'){ return; }
				...
				var calendar = jQuery('#calendar').fullCalendar({
				  ...
				  select: function(start, end, allDay) {
					jQuery('#fc_create').click();

					started = start;
					ended = end;

					jQuery(".antosubmit").on("click", function() {
					  var title = jQuery("#title").val();
					  if (end) {
						ended = end;
					  }

					  categoryClass = jQuery("#event_type").val();
					  ...
					  jQuery('.antoclose').click();

					  return false;
					});
				  },
				  eventClick: function(calEvent, jsEvent, view) {
					jQuery('#fc_edit').click();
					jQuery('#title2').val(calEvent.title);

					categoryClass = jQuery("#event_type").val();

					jQuery(".antosubmit2").on("click", function() {
					  calEvent.title = jQuery("#title2").val();

					  calendar.fullCalendar('updateEvent', calEvent);
					  jQuery('.antoclose2').click();
					});
		...
		/* DATA TABLES */
			...
			function init_DataTables() {
				...
				jQuery('#datatable-fixed-header').DataTable({
				  fixedHeader: true
				});

				var $datatable = jQuery('#datatable-checkbox');
		...
		function init_morris_charts() {
			...
			if (jQuery('#graph_bar_group').length ){
		...
		function init_echarts() {
			...
			if (jQuery('#echart_pyramid').length ){ 
			...
			if (jQuery('#echart_scatter').length ){ 
			...
			if (jQuery('#echart_bar_horizontal').length ){ 
			...
			if (jQuery('#echart_mini_pie').length ){ 
			...
			if (jQuery('#echart_world_map').length ){ 
