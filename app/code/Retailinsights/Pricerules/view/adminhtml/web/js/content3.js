require(['jquery', 'jquery/ui',"mage/calendar"], function($) { 
   ...
   //$(".btnclass").click(function(event) {
          ...
          var buy_product_one = document.getElementById('buy_product_one').value;
          var buy_product_two = document.getElementById('buy_product_two').value;
        ...
        console.log(store_id);
          console.log(buy_product_one);
          console.log(buy_product_two);
          ...
          if(buy_product_one == '' || buy_product_two == '' || fixed_price == ''||priority == '' ||  fromdate_offer == '' || todate_offer == '' || customer_group == '')
          {
          ...
          else
          {
            if(post_id){
                ...
                var param={ 
                    ...
                    name:name,
                    store_id:store_id,
                    buy_product_one:buy_product_one,
                    buy_product_two:buy_product_two,
            ...
            //alert(admin_path);
            var customurl = window.location.origin+'/'+admin_path+'/retailinsights_pricerules/postthree/save';
           // alert(customurl);
