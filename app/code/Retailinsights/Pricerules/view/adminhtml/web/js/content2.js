require(['jquery', 'jquery/ui', "mage/calendar"], function ($) {
    ...
    $(".btnworth").click(function (event) {
        ...
        if (subtotal == '' || get_product == '' || quantity == '' || priority == '' || fromdate_offer == '' || todate_offer == '' || customer_group == '') {
            ...
            //alert(admin_path);
            var customurl = window.location.origin +'/'+ admin_path + '/retailinsights_pricerules/postWorth/save';
            // alert(customurl);
