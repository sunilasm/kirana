require(['jquery', 'jquery/ui',"mage/calendar"], function($) { 
 ...
 $(".btnxyzoff").click(function(event) {
...
//        var buy_product = document.getElementById('buy_product').value;
        ...
        if(name == ''|| store_id =='' || fixed_price == ''||priority == '' ||fromdate_offer == '' ||todate_offer == '' ||customer_group == '')
        {
        ...
        else
        {
          ...
          var customurl = window.location.origin+'/'+admin_path+'/retailinsights_pricerules/postXYZoff/save';
