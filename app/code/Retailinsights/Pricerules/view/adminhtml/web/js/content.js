require(['jquery', 'jquery/ui',"mage/calendar"], function($) { 
   ...
   //$(".btnclass").click(function(event) {
        ...
        console.log(store_id);
          ...
          if(buy_product == '' || buy_quantity == '' || get_product == '' ||  get_quantity == '' ||buy_quantity == '' ||priority == '' ||  fromdate_offer == '' || todate_offer == '' || customer_group == '')
          {
          ...
          else
          {
            ...
            var customurl = window.location.origin+'/'+admin_path+'/retailinsights_pricerules/Post/save';
